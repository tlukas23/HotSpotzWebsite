<?php
    ...
    $searchCount = 0;
    $sql = "SELECT * FROM Locations WHERE (Verified = $verified AND (Name LIKE '%$search%' OR Phone LIKE '%$search%' OR Address LIKE '%$search%' OR Distance LIKE '%$search%')) ORDER BY Name";
